...
Modern React.js frontend application for the Hospital Appointment System.

## Features

- **User Management Interface** - View and manage doctors and patients
...
- **Statistics Dashboard** - User insights and metrics
